...
public class AllPairShortestPath {
    ...
    void floydWarshall(int[][] graph){
        ...
        //---->Before start of an interation, we have shortest distances
        ...
        //---->After the end of an iteration, vertex no. k is added to the
        //      set of intermediate vertices and the set becomes
        //      {0, 1, 2, .. k}
        for(k = 0; k < V; k++){
